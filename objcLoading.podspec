...
# s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  ...
  s.source           = { :git => "https://github.com/vilyever/objcLoading.git", :tag => s.version.to_s }
# s.social_media_url = 'https://twitter.com/vilyever'

  s.platform     = :ios, '7.0'
  s.requires_arc = true

  s.source_files = 'objcLoading/**/*.{h,m}'
# s.resource_bundles = {
#   'objcLoading' => ['objcLoading/**/*.png']
# }
